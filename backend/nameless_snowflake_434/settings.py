"""
Django settings for nameless_snowflake_434 project.
...
ROOT_URLCONF = 'nameless_snowflake_434.urls'
...
WSGI_APPLICATION = 'nameless_snowflake_434.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "nameless_snowflake_434 API",
    "DESCRIPTION": "API documentation for nameless_snowflake_434 App",
    "VERSION": "v1",
}
